...
def design_lowpass_fir(numtaps, cutoff, fs):
    ...
    taps = signal.firwin(numtaps, norm_cutoff, window='boxcar', pass_zero=True)
    return taps

# Baca file WAV
input_wav_path = r'C:\Users\T530 ThinkPad\Documents\VS CODE\UAS PSD\Input.wav'
output_wav_path = r'C:\Users\T530 ThinkPad\Documents\VS CODE\UAS PSD\Output\Output_Rectangle.wav'
